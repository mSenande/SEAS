...
origin.addEventListener('input',function(evento){
    ...
    plot2.src = plotsBaseURL+origin_valor.split('.')[0]+'_'+origin_valor.split('.')[1]+'_stmonth'+str_stdate+'_hindcast1993-2016_monthly.'+imgbasename+'.'+varn_valor+'.'+score_valor+'.png'
})
...
score.addEventListener('input',function(evento){
    ...
    plot1.src = plotsBaseURL+score_valor+'_sf_DJF_3m.png'
})
